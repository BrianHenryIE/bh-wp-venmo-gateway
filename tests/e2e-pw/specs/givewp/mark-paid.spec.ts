 ...
 *
 * The "Mark paid" row action hooks GiveWP's legacy donations list table
 * (give_payments_table_column); the initialize script opts the admin into that
 * legacy list (_give_donations_archive_show_legacy) since Give 3.x otherwise
 * renders a React list that has no equivalent hook.
 */
